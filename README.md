...
| [docs/graphs.md](docs/graphs.md) | **The two portfolio graphs** — repo-graph (coverage/ownership) vs portfolio-graph (code-level L0–L4), what each holds, every consumer of each, and what a stale graph gets wrong |
