...
| [docs/graphs.md](docs/graphs.md) | **Every graph the harness builds or reads** — repo-graph, portfolio-graph, findings.db, the ATT&CK Navigator layer, per-finding attack chains, and transient reachability call graphs; what each answers, who consumes it, and what staleness costs |
